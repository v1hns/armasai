...
// ── Plain-English explainer: one quick Claude Haiku call per pipeline stage ──
const STAGE_HINT = {
  capture: 'the input clip', perception: 'what the vision model saw and which arm needs the prosthesis',
  design: 'the prosthetic arm it sized', simulation: 'how the design did in physics simulation',
  policy: 'the controller it built', cad: 'the assembled printable model',
}
